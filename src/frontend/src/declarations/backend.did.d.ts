...
export interface _SERVICE {
  ...
  'getTraineeProgress' : ActorMethod<[], TraineeProgress>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  /**
   * / * PDF Import (Admin Only)
   */
  'importPdf' : ActorMethod<[Uint8Array], string>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  /**
   * / * Progress Tracking (User Only)
   */
  'markLessonCompleted' : ActorMethod<[string], undefined>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  /**
   * / * Course and Lesson Management (Admin Only)
   */
  'saveCourse' : ActorMethod<[Course], undefined>,
  'saveLesson' : ActorMethod<[Lesson], undefined>,
  /**
   * / * Content Status Management (Admin Only)
   */
  'setContentStatus' : ActorMethod<[string, ContentStatus, boolean], undefined>,
